//
// Created by haoming on 16.06.22.
//
...
#include <irt_msgs/msg/gnss_correction.hpp>
#include <irt_msgs/msg/sat_label.hpp>
...
namespace fgo::utils::GNSS {
    ...
    inline void getRTKCorrectionsFromROSMsg(const std::vector<irt_msgs::msg::GNSSCorrection>& corrections,
                                            std::vector<irt_msgs::msg::SatLabel>& labels)
    {
    ...
    inline double calculateDDVariance(const std::string &method,
     ...
     inline data_types::GNSSPVTSolutionType getOEM7PVTSolutionType(uint32_t type)
     {
       switch (type) {
         case 0: {
           return data_types::GNSSPVTSolutionType::NO_SOLUTION;
         }
         case 16: case 17: case 18:  case 51:  case 52:  case 53: {
           return data_types::GNSSPVTSolutionType::SINGLE;
         }
         case 32: case 34:  case 55: {
           return data_types::GNSSPVTSolutionType::RTKFLOAT;
         }
         case 48: case 49: case 50:  case 56: {
           return data_types::GNSSPVTSolutionType::RTKFIX;
         }
         default:
           return data_types::GNSSPVTSolutionType::SINGLE;
       }
    ...
    inline data_types::GNSSPVTSolutionType getUbloxSolutionType(uint8_t fix_type, uint8_t flags)
    {
    ...
    inline data_types::GNSSPVTSolutionType getSBFSolutionType(uint8_t error, uint8_t type)
    {
      /*
       * switch Error
              case SOL_COMPUTED
